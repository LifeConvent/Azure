...
<head>
    ...
    <link href="/Azure/CESBack/Public/assets/font-awesome/css/font-awesome.css" rel="stylesheet"><!-- 字体 -->
    <link href="/Azure/CESBack/Public/css/style.css" rel="stylesheet"><!-- THEME BASIC CSS -->
    <link href="/Azure/CESBack/Public/css/style-responsive.css" rel="stylesheet"><!-- THEME RESPONSIVE CSS -->
    <link href="/Azure/CESBack/Public/assets/morris.js-0.4.3/morris.css" rel="stylesheet"><!-- MORRIS CHART CSS -->
    <!--dashboard calendar-->
    <link href="/Azure/CESBack/Public/css/clndr.css" rel="stylesheet"><!-- CALENDER CSS -->
    <!--[if lt IE 9]>
    <script src="/Azure/CESBack/Public/js/html5shiv.js">
    </script>
    <script src="/Azure/CESBack/Public/js/respond.min.js">
    </script>
    <![endif]-->
    <!-- END STYLESHEET-->
</head>
...
<!-- JS -->
<script src="/Azure/CESBack/Public/js/jquery-3.1.1.min.js"></script><!-- BASIC JQUERY 1.8.3 LIB. JS -->
<script src="/Azure/CESBack/Public/js/bootstrap.min.js"></script><!-- BOOTSTRAP JS -->
<script src="/Azure/CESBack/Public/js/jquery.dcjqaccordion.2.7.js"></script><!-- 左侧子菜单栏显示 -->
<script src="/Azure/CESBack/Public/js/jquery.scrollTo.min.js"></script><!-- SCROLLTO JS -->
<script src="/Azure/CESBack/Public/js/jquery.nicescroll.js"></script><!-- NICESCROLL JS -->
<script src="/Azure/CESBack/Public/js/respond.min.js"></script><!-- RESPOND JS -->
<script src="/Azure/CESBack/Public/js/jquery.sparkline.js"></script><!-- SPARKLINE JS -->
<script src="/Azure/CESBack/Public/js/sparkline-chart.js"></script><!-- SPARKLINE CHART JS -->
<script src="/Azure/CESBack/Public/js/common-scripts.js"></script><!-- BASIC COMMON JS -->

<!--统计框Morris-->
<script src="/Azure/CESBack/Public/assets/morris.js-0.4.3/morris.min.js"></script><!-- MORRIS JS -->
<script src="/Azure/CESBack/Public/assets/morris.js-0.4.3/raphael-min.js"></script><!-- MORRIS  JS -->
<script src="/Azure/CESBack/Public/js/chart.js"></script><!-- CHART JS -->

<!--自定义-->
<script src="/Azure/CESBack/Public/js/Home/count.js"></script>
<script src="/Azure/CESBack/Public/js/Home/get-time.js"></script>
<script src="/Azure/CESBack/Public/js/Home/charts-home.js"></script>
<script src="/Azure/CESBack/Public/js/Home/home.js"></script>
<script>
